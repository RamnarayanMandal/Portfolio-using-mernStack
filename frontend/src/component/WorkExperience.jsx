    ...
    >
      <div className="container mx-auto">
        <div className="text-center mb-10">
          ...
          <span
            className={`block w-20 h-1 ${
              isDarkMode ? "bg-blue-500" : "bg-blue-800"
            } mx-auto mt-2`}
          ></span>
        </div>
        <div className="relative">
          ...
          <div
            className={`absolute left-8 md:left-24 h-full ${
              isDarkMode ? "border-gray-600" : "border-blue-800"
            } border-l-4`}
          ></div>
          ...
          {experience.map((exp, index) => (
            ...
            >
              {/* Timeline Icon */}
              <div
                className={`absolute left-4 md:left-20 w-12 h-12 ${
              ...
              {/* Experience Content */}
              <div
                className={`p-6 rounded-lg shadow-lg relative w-full ${
                  isDarkMode
